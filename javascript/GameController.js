    ...
    this.scenes = [
      {
        ...
        "objects": [
          ...
          new Block(this, new Vector3D(6, 0, 0), new Vector3D(2, 0.4, 2), "0xaaaaaa", "textures/iron_texture.jpg", (obj) => { obj.pos.x = 10 * Math.sin(performance.now() / 2000 + 3) + 10.1; obj.vel.x = 20/10000 * Math.cos(performance.now() / 300 + 3); } ), //elevator
