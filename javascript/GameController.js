    ...
    this.scenes = [
      {
        ...
        "objects": [
          ...
          new Block(this, new Vector3D(6, 0, 0), new Vector3D(2, 0.4, 2), "0xaaaaaa", "textures/iron_texture.jpg", (obj) => { obj.pos.y = 10 * Math.sin(performance.now() / 500 + 3) + 10.1; obj.vel.y = 20/10000 * Math.cos(performance.now() / 500 + 3); } ), //elevator
        ],
        "npcs": [
          this.player,
        ]
