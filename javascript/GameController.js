    ...
    this.scenes = [
      {
        ...
        "objects": [
          ...
          new Block(this, new Vector3D(6, 0, 0), new Vector3D(2, 0.4, 2), "0xaaaaaa", "textures/iron_texture.jpg", (obj) => { obj.pos.y = 100 * Math.sin(performance.now() / 10000 + 3) + 10.1; obj.vel.y = 100/10000 * Math.cos(performance.now() / 10000 + 3); } ), //elevator
          new Block(this, new Vector3D(12, 0, 0), new Vector3D(2, 0.4, 2), "0xaaaaaa", "textures/wood_texture.jpg", (obj) => { obj.pos.x = 10 * Math.sin(performance.now() / 2000 + 3) + 10.1; obj.vel.x = 10/2000 * Math.cos(performance.now() / 2000 + 3); } ), //elevator
